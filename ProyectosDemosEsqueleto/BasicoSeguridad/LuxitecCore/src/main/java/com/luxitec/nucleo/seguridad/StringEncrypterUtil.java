...
public class StringEncrypterUtil {
     ...
     *                   decrypter instances.
     */
    StringEncrypterUtil(SecretKey key, String algorithm) {
        try {
     ...
     *                   decrypter instances.
     */
    StringEncrypterUtil(String passPhrase) {
    ...
    public static void testUsingSecretKey() {
        try {
            ...
            StringEncrypterUtil desEncrypter = new StringEncrypterUtil(desKey, desKey.getAlgorithm());
            StringEncrypterUtil blowfishEncrypter = new StringEncrypterUtil(blowfishKey, blowfishKey.getAlgorithm());
            StringEncrypterUtil desedeEncrypter = new StringEncrypterUtil(desedeKey, desedeKey.getAlgorithm());
    ...
    public static void testUsingPassPhrase() {
        ...
        // Create encrypter/decrypter class
        StringEncrypterUtil desEncrypter = new StringEncrypterUtil(passPhrase);
